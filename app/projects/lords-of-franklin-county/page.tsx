...
export default function PinesPage() {
  ...
  const currentSlug = "lords-of-franklin-county";
...
<section className="md:hidden relative w-full h-[70vh] overflow-hidden">
  ...
  <div className="relative z-10 flex flex-col justify-end h-full px-6 pb-16">
    ...
    <p className="text-sm text-zinc-300 leading-relaxed">
      Justice isn’t always lawful—and sometimes doing right means becoming the thing you hate.
    </p>
  ...
  Kris Shuman
      ...
      <div className="relative z-10 flex flex-col justify-end h-full px-16 pb-24 w-full">
        ...
        <h1 className="text-[clamp(2.5rem,5vw,5rem)] font-bold leading-[1.05] mb-0 w-full">
          <span className="block">LORDS OF FRANKLIN COUNTY</span>
        </h1>
  ...
  <div className="max-w-5xl mx-auto px-6 md:px-12">
    ...
    <div className="text-center">
      ...
      <div className="inline-block text-left">
        ...
        ">
          “They were free… until a man with a rifle came along and took it from ‘em.”
        </p>
    ...
    <div className="grid md:grid-cols-2 gap-16 max-w-4xl">
      ...
      <div>
        ...
        <ul className="space-y-3 text-lg text-white/80">
          <li>Justice Vs. Revenge</li>
          <li>Faith Vs. Action</li>
